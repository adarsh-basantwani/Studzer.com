<%@ Page Title="Mess Bookings" Language="C#" MasterPageFile="~/cba321/cba322.Master" AutoEventWireup="true" CodeBehind="MessBooking.aspx.cs" Inherits="students1.cba321.Mess.MessBooking" %>
...
<hr />
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="MessId" HeaderText="MessId" 
                SortExpression="MessId" />
            <asp:BoundField DataField="Name" HeaderText="Name" SortExpression="Name" />
            <asp:BoundField DataField="ContactNo" HeaderText="ContactNo" 
                SortExpression="ContactNo" />
            <asp:BoundField DataField="MessStatus" HeaderText="MessStatus" 
                SortExpression="MessStatus" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT SrNo, MessId, Name, ContactNo, MessStatus, Rating FROM Booking WHERE (MessId IS NOT NULL)" 
