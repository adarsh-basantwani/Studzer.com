<%@ Page Title="Flat Requests" Language="C#" MasterPageFile="~/cba321/cba322.Master" AutoEventWireup="true" CodeBehind="FlatRequests.aspx.cs" Inherits="students1.cba321.Flat.FlatRequests" %>
...
<ControlStyle Height="100px" Width="100px"></ControlStyle>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT FlatId, ActivationDate, OwnerName, ContactNo1, ContactNo2, FlatLocation, Gender, State, City, NearestLocation, UploadPhoto1, UploadPhoto2, UploadPhoto3, FlatType, BathRoom, Floor, Rent, SecurityDeposit, FlatArea, LightBill, Parking, MoreAboutFlat, Status, Counter, Confirm, Disable, UserId, New FROM Flat WHERE (Disable = @Disable)" 
