<%@ Page Title="Flat Booking" Language="C#" MasterPageFile="~/cba321/cba322.Master" AutoEventWireup="true" CodeBehind="FlatBooking.aspx.cs" Inherits="students1.cba321.Flat.FlatBooking" %>
...
<hr />
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="FlatId" HeaderText="FlatId" 
                SortExpression="FlatId" />
            <asp:BoundField DataField="Name" HeaderText="Name" SortExpression="Name" />
            <asp:BoundField DataField="ContactNo" HeaderText="ContactNo" 
                SortExpression="ContactNo" />
            <asp:BoundField DataField="FlatStatus" HeaderText="FlatStatus" 
                SortExpression="FlatStatus" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT SrNo, FlatId, Name, ContactNo, FlatStatus, Rating FROM Booking WHERE (FlatId IS NOT NULL)" 
