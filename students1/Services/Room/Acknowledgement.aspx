<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Acknowledgement.aspx.cs" Inherits="students1.Services.Acknowledgement" EnableEventValidation = "false" %>
...
<body>
    ...
    <div>
        ...
        <asp:DataList ID="DataList1" runat="server" DataKeyField="ContactNo" 
            ...
            <table><tr><td>Room Location:</td><td><asp:Label ID="RoomLocationLabel" runat="server" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT Users.Name, Users.ContactNo, Users.Education, Users.City, Users.State, Room.RoomLocation, Room.Name AS Expr1, Room.ContactNo1, Room.ContactNo2 FROM Users CROSS JOIN Room WHERE (Room.RoomId = @RoomId) AND (Users.ContactNo = @UserId)">
            <SelectParameters>
