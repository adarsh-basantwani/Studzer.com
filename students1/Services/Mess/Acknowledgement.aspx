<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Acknowledgement.aspx.cs" Inherits="students1.Services.Mess.Acknowledgement" EnableEventValidation = "false" %>
...
<body>
    ...
    <h3><asp:Label ID="Label1" runat="server" Text="You can take screenshot or Save as Pdf of this page. You have to show this confirmation page to Owner for security purpose." ForeColor="Red"></asp:Label></h3>
        <asp:DataList ID="DataList1" runat="server" DataKeyField="ContactNo" 
            ...
            <table><tr><td>Mess Location:</td><td><asp:Label ID="RoomLocationLabel" runat="server" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT Users.Name, Users.ContactNo, Users.Education, Users.City, Users.State, Mess.MessLocation, Mess.Name AS Expr1, Mess.ContactNo1, Mess.ContactNo2 FROM Users CROSS JOIN Mess WHERE (Mess.MessId = @MessId) AND (Users.ContactNo = @UserId)">
            <SelectParameters>
                <asp:SessionParameter Name="UserId" SessionField="UserId" />
                <asp:SessionParameter Name="MessId" SessionField="MessId" />
            </SelectParameters>
        </asp:SqlDataSource>
    </div>
    <h3>Note:</h3>
