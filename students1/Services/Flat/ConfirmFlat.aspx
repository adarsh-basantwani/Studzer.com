<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfirmFlat.aspx.cs" Inherits="students1.Services.Flat.ConfirmFlat" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Confirm Flat</title>
</head>
<body>
   ...
   <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        UpdateCommand="UPDATE Flat SET Confirm = @Confirm, Disable = @Disable WHERE (FlatId = @FlatId)">
            <DeleteParameters>
