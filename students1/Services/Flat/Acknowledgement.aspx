<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Acknowledgement.aspx.cs" Inherits="students1.Services.Flat.Acknowledgement" EnableEventValidation = "false" %>
...
<body>
    ...
    <div>
        ...
        <asp:DataList ID="DataList1" runat="server" DataKeyField="ContactNo" 
            ...
            <ItemTemplate>
         <h3><asp:Label ID="Label1" runat="server" Text="Owner Details"></asp:Label></h3>
            <table><tr><td>Flat Location:</td><td><asp:Label ID="RoomLocationLabel" runat="server" 
                    Text='<%# Eval("FatLocation") %>' />
                </td></tr>
                <tr><td>Name:</td><td>
                <asp:Label ID="Expr1Label" runat="server" Text='<%# Eval("OwnerName") %>' />
                </td></tr>
                ...
                <hr />
                <h3><asp:Label ID="Label2" runat="server" Text="Student Details"></asp:Label></h3>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT Users.Name, Users.ContactNo, Users.Education, Users.City, Users.State, Flat.FlatLocation, Flat.OwnerName, Flat.ContactNo1, Flat.ContactNo2 FROM Users CROSS JOIN Flat WHERE (Flat.FlatId = @FlatId) AND (Users.ContactNo = @UserId)">
            <SelectParameters>
                <asp:SessionParameter Name="UserId" SessionField="UserId" />
                <asp:SessionParameter Name="FlatId" SessionField="FlatId" />
            </SelectParameters>
        </asp:SqlDataSource>
    </div>
    <h3>Note:</h3>
