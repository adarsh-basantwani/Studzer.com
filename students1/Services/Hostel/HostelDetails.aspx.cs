...
namespace students1.Services.Hostel
{
    public partial class HostelDetails : System.Web.UI.Page
    {
        ...
        protected void btnUpload_Click(object sender, EventArgs e)
        {
            ...
            {
                {
                    Response.Write("<script>alert('Congratulations.. Your Hostel is Reposted on Our Site. Our Representative will Come to You and Collect the Money for Your Selected Scheme')</script>");
                }
