<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="students1.Account.Login" %>
...
<body>
  ...
  <form runat="server" id="form1">
   <asp:TextBox ID="txtUserName" runat="server" placeholder="Phone number or email address"></asp:TextBox>
   ...
   <asp:Button ID="btnSubmit" runat="server" Text="LogIn" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
       ...
       SelectCommand="SELECT Name, Gender, ContactNo, Password, EmailId FROM Users WHERE (Password = @Password) AND (ContactNo = @ContactNo) OR (EmailId = @EmailId)">
        <SelectParameters>
  ...
  <div class="login-help">
       ...
       <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Account/Register.aspx">Register</asp:HyperLink> • <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/Account/ForgotPassword.aspx">Forgot Password</asp:HyperLink>
  </div>
</div>
